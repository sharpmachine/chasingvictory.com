...
?>
<li itemprop="reviews" itemscope itemtype="http://schema.org/Review" <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>" class="reviews-from-customers">
	<div class="col-sm-6 customer-review">
